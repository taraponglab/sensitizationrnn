...
def main():
    # Load data from CSV
    x_train = pd.read_csv("sensitization_x_train_tox_rdkit_descriptors.csv",index_col=0)
    x_test = pd.read_csv("sensitization_x_test_tox_rdkit_descriptors.csv",index_col=0)
