...
def train_bilstm_model(x_train, x_test, y_train, y_test, model_filename='bilstm_maccs_phychem.keras', plot_filename='bilstm_maccs_phychem.png', epochs=50, batch_size=2):
