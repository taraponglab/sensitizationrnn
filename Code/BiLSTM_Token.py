...
def main():
    # Load data from CSV
    x_train = pd.read_csv("sensitization_x_train_augmented_smiles_token.csv",index_col=0)
    x_test = pd.read_csv("sensitization_x_test_augmented_smiles_token.csv",index_col=0)
