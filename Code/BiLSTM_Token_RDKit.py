...
def train_bilstm_model(x_train, x_test, y_train, y_test, model_filename='bilstm_token_rdkit.keras', plot_filename='bilstm_token_rdkit.png', epochs=50, batch_size=2):
    ...
    return y_test_pred_prob,accuracy_train, accuracy_test,mcc_train,mcc_test,precision_train,precision_test,recall_train,recall_test, specificity_train,specificity_test,roc_auc_test,roc_auc_train, model_filename, plot_filename
