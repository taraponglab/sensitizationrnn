...
def train_gru_model(x_train, x_test, y_train, y_test, model_filename='gru.keras', plot_filename='training_lost.png', epochs=50, batch_size=2):
...
def main():
    ...
    accuracy_train, accuracy_test,mcc_train,mcc_test,precision_train,precision_test,recall_train,recall_test, specificity_train,specificity_test, roc_auc_test,roc_auc_train, model_file, plot_file = train_gru_model(x_train, x_test, y_train, y_test)
